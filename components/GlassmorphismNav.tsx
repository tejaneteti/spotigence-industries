...
export function GlassmorphismNav() {
    ...
    return (
        <>
            <nav
                className={`fixed z-50 top-4 md:top-8 left-1/2 -translate-x-1/2 z-50 transition-all duration-500 ${isVisible ? "translate-y-0 opacity-100" : "-translate-y-20 md:-translate-y-24 opacity-0"
            ...
            >
                {/* Main Navigation */}
                <div className="w-[90vw] max-w-xs md:max-w-4xl lg:max-w-7xl mx-auto">
                            ...
                            <div className="hidden md:flex items-center space-x-8">
                                ...
                                (
                                    <Link
                                        key={item.name}
                                        href={item.href}
                                        className={cn("text-white/80 hover:text-white hover:scale-105 transition-all duration-200 font-medium cursor-pointer", path === item.href ? "text-white" : "")}
                                    >
                                        {item.name}
                                    </Link>
                                )
